...
#             action = actions_value[0]  # if ENV_A_SHAPE == 0 else action.reshape(ENV_A_SHAPE)  # return the argmax index
#         else:  # random
#             action = np.random.rand(0, self.action_space)
#         return action
#
#     def learn(self, x):
#         pass
#
#     def pandulum_train_loop(self, env):
#         pass
