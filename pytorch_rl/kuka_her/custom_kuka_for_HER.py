...
class KukaGymEnv(gym.Env):
    ...
    def _reset(self):
        ...
        self._envStepCounter = 0
        p.stepSimulation()
        self._observation, self._goal = self.getExtendedObservation(), self.get_block_pos()
    ...
    def step2(self, action):
        ...
        self._observation, self._gripperpos = self.getExtendedObservation(), self.get_gripper_pos()
        ...
        return np.array(self._observation), reward, done, np.array(self._gripperpos), {}
    ...
    def _termination(self):
        ...
        if (len(closestPoints)):  # (actualEndEffectorPos[2] <= -0.43):
            ...
            return True
        return False
    # 원래 reward 함수에서와 다르게 blockPos의 z 좌표가 0.2보다 작으면 -1, 크면(블럭을 들면) 0으로 주도록 만들었습니다.
    def _reward(self):
